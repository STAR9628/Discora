-- Companion to 202606040003 chain repair.
-- Restores the full moderation_queue definition with inquiry_items support.
-- MUST be deployed to production together with 202606040003.
--
-- This migration is idempotent and uses the exact definition from
-- 202606240003_fix_moderation_queue_regression.sql.
