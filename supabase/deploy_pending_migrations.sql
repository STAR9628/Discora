...
-- === 13. 202606240001_fix_discussion_messages_view.sql ===
...
-- === 14. 202606240002_moderation_inquiry_feedback.sql ===
...
-- === 15. 202606240003_fix_moderation_queue_regression.sql ===
...
-- === 16. 202606240004_update_moderation_constraint.sql ===
...
-- === 17. 202606240005_drop_legacy_submit_moderation_flag.sql ===
...
-- === 18. 202606250001_fix_discussion_evidence_room_id.sql ===
-- Migration: Restore room_id and vote aggregates to discussion_evidence view
-- Root cause: 202606210001 recreated discussion_evidence without room_id,
-- agree_count, disagree_count, consensus_ratio, and user_vote.
-- This broke frontend queries that filter by room_id and read vote metadata.
...
-- === 19. 202606260001_create_user_saves.sql ===
...
-- === 20. 202606260005_save_target_room_type_integrity.sql ===
...
-- === 21. 202606260004_fix_recent_engagement_rpc.sql ===
-- Migration: Fix get_my_recent_engagement to use latest row per room
