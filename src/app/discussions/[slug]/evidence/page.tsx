...
export async function generateMetadata({
  ...
  const title = item?.room.title ? `${item.room.title} | Evidence` : "Evidence";
  return {
    title,
    description: item?.room.description || "Evidence and sources supporting or rebutting claims in this discussion.",
  };
}
